...
* [Demo](#demo)
* [Abstract](#abs)
* [Motivation](#mot)# SMS SPAM Detection
...
* The **most common words** used in **SPAM** messages can be seen from the **WordCloud** below.
    ...
    * The graph says the same - 
    
    <img src='https://raw.githubusercontent.com/animesharma3/SPAM-SMS-Detection/master/images/download%20(3).png' width='1000px'>
